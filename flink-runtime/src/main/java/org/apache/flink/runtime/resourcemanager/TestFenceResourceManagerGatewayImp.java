...
public class TestFenceResourceManagerGatewayImp extends FencedRpcEndpoint<ResourceManagerId> implements ResourceManagerGateway{
	protected TestFenceResourceManagerGatewayImp(RpcService rpcService, String endpointId) {
		super(rpcService, endpointId);
		setFencingToken(ResourceManagerId.fromUuidOrNull(HighAvailabilityServices.DEFAULT_LEADER_ID));
	}

	protected TestFenceResourceManagerGatewayImp(RpcService rpcService) {
		super(rpcService);
	}
